  ...
  if (deploy === false) {
    ...
    if (showDefault) {
      ...
      if (myCityCharLength > 22) {
        myCity[0].style.fontSize = "12.7px"
        myCity[1].style.fontSize = "12.7px"
        to[0].insertAdjacentHTML('afterend', '<br>')
        h4[0].style.lineHeight = "17px"
...
function animate() {
  ...
  .staggerTo(['#h4', '#priceHolder', '#cta', '#terms', '#terms_container'], 0.5, { autoAlpha: 1, ease: Power1.easeInOut }, 0.3, 'frame_4+=0.5')
